...
function CardDetails(props) {
    ...
    return (
       <>
             <div className='card bg-slate-700 text-center w-4/12 m-auto mt-60 h-fit flex flex-col  rounded-2xl relative shadow-2xl max-sm:w-11/12 max-lg:w-7/12 max-xl:w-5/12 max-2xl:w-5/12 font-mono'>
      ...
      <div className='bg-green-400 rounded-full w-16 h-16 m-auto hover:cursor-pointer  ' onClick={() => window.location.reload()}>
